...
c1.metric("Exp. annual return", f"{port_return100:.2f}%")
c2.metric("Est. volatility (σ)", f"{port_vol100:.2f}%")
...
DATA FECHER FILE ( ALTHOUGH I NEED TO ADD WHT WE JUST MADE IN THIS OUT CURRENT PROJECT)-
import yfinance as yf
import requests
import pandas as pd
